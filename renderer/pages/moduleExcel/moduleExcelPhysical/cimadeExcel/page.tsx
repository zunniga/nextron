...
import ImageUploader from '../../../../components/modulos/modulePhysical/cimade/ImageFrom';
...
const ExcelDataFrom = () => {
  ...
  return (
    <section className='bg-[#002e79] min-h-screen pb-20'>
      ...
      <Link href="/modulePdf/modulePdfPhysical/cimadePdf/page" className={`flex p-10 font-mono ${!excelLoaded ? 'pointer-events-none' : ''}`}>
          <button className={`bg-[#65036a] px-10 py-3 text-white rounded-xl uppercase text-3xl mb-10 mt-10 mr-48 hover:scale-110 duration-300 ${!excelLoaded || buttonDisabled ? 'opacity-50' : ''}`} disabled={buttonDisabled}>
