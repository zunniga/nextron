...
import ImageUploader from '../../../../components/modulos/modulePhysical/ecomas/ImageFrom';
...
const ExcelDataFrom = () => {
  ...
  return (
    <section className='bg-[#001D51] min-h-screen pb-20'>
      ...
      <Link href="/modulePdf/modulePdfPhysical/ecomasPdf/page" className={`flex p-10 font-mono ${!excelLoaded ? 'pointer-events-none' : ''}`}>
