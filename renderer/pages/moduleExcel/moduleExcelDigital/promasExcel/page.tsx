...
import ImageUploader from '../../../../components/modulos/moduleDigital/promas/ImageFrom';
...
const ExcelDataFrom = () => {
  ...
  return (
    <section className='bg-[#360B7F] min-h-screen pb-20'>
      ...
      <div className='flex justify-center items-center mt-5 gap-6 p-8 bg-[#B20076]/70'>
      ...
      <div className="p-10 ml-40 font-mono text-3xl hover:scale-110 duration-300">
        ...
        <Link href="/modulePdf/modulePdfDigital/promasPdf/page" className={`flex p-10 font-mono ${!excelLoaded ? 'pointer-events-none' : ''}`}>
      ...
      <div className='max-w-[1500px] mx-auto grid grid-cols-2 p-4 border-4 border-[#FD4660]/70 rounded-2xl'>
        <div className=''>
