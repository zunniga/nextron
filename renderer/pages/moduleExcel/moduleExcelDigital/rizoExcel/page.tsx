...
import ImageUploader from '../../../../components/modulos/moduleDigital/rizo/ImageFrom';
  ...
  return (
    <section className='bg-[#1C004C]/70 min-h-screen pb-20'>
      ...
      <div className="p-10 ml-40 font-mono text-3xl hover:scale-110 duration-300">
        ...
        <Link href="/modulePdf/modulePdfDigital/rizoPdf/page" className={`flex p-10 font-mono ${!excelLoaded ? 'pointer-events-none' : ''}`}>
