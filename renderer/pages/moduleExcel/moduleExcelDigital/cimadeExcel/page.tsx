...
import ImageUploader from '../../../../components/modulos/moduleDigital/cimade/ImageFrom';
  ...
  return (
    <section className='bg-[#002e79] min-h-screen pb-20'>
      ...
      <div className="p-10 ml-40 font-mono text-3xl hover:scale-110 duration-300">
        ...
        <Link href="/modulePdf/modulePdfDigital/cimadePdf/page" className={`flex p-10 font-mono ${!excelLoaded ? 'pointer-events-none' : ''}`}>
