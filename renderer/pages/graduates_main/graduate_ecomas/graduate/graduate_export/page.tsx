...
export default function Home() {
  ...
  useEffect(() => {
    ...
    if (mostrarConfetti) {
      ...
      }, 5000) // Ocultar confetti después de 3 segundos
    }
  }, [mostrarConfetti])
      ...
      <header className="mt-8 text-center">
        ...
        <ul className="steps w-full">
          ...
          <li className="step step-warning font-extralight text-xl ">
            ...
            <Link
              href="/graduates_main/graduate_ecomas/graduate/graduate_reverso/page"
              passHref
              legacyBehavior
            >
          ...
          <li className="step step-warning font-extralight text-xl ">
            <Link href="/graduates_main/graduate_ecomas/graduate/graduate_reverso/page">
          ...
          <li className="step step-warning font-extralight text-xl">
            ...
            <Link
              href="/graduates_main/graduate_ecomas/graduate/graduate_export/page"
              passHref
              legacyBehavior
            >
              <button className=" bg-[#001d51] text-white btn btn-outline hover:bg-[#178617] hover:text-white mt-4">
