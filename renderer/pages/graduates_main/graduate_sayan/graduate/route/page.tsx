...
export default function Home() {
  ...
  return (
    <div className=" min-h-screen bg-[#0d617b]/70  overflow-hidden">
      <Link href="/graduates_main/graduate_sayan/routess/page">
        <BiLogOut
          color="#ffff"
      ...
      <header className="mt-8 text-center mb-10">
        ...
        <ul className="steps w-full">
          ...
          <li className="step font-extralight text-xl">
            ...
            <Link
              href="/graduates_main/graduate_sayan/graduate/graduate_reverso/page"
              passHref
              legacyBehavior
            >
              <button className=" bg-[#0d617b] text-white btn btn-outline hover:bg-[#b6d900]/70 hover:text-white mt-4">
