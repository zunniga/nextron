...
import { openDatabase } from '../../../../components/modulos/modulePhysical/ecomas/database/index';
        ...
        {imageGroups.map((group, groupIndex) => (
          <div key={groupIndex} className='flex justify-center'>
            <div className='gap-10 inline-flex items-center text-xl'>
              <h3 className='flex justify-between w-[1000px] border-4 border-[#0060ff] text-gray-200 p-4 mt-5 items-center rounded-xl font-bold'>{group.name}
