...
import { openDatabase } from '../../../../components/modulos/modulePhysical/rizo/database/index';
        ...
        {imageGroups.map((group, groupIndex) => (
          <div key={groupIndex} className='flex justify-center'>
            <div className='gap-10 inline-flex items-center text-xl'>
              <h3 className='flex justify-between w-[1000px] border-4 border-[#6D0083] text-gray-200 p-4 mt-5 items-center rounded-xl font-bold'>{group.name}
                <span className="text-sm text-gray-400 ml-1">
                  ({group.images.length} módul{group.images.length !== 0 ? 'os' : ''})
                </span>
              </h3>
              <button onClick={() => openModal(group)} className='w-40 p-4 mt-5 bg-[#6D0083] text-gray-200 rounded-xl font-mono hover:scale-110 duration-300'>Ver módulos</button>
