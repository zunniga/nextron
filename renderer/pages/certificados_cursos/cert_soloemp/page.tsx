...
const imageDB = new ImageDatabaseCursos(); // Asegúrate de crear la instancia de la base de datos
...
export default function Home() {
  ...
  return (
    <div className="bg-[#1c222a] h-screen overflow-hidden">
      ...
      <div
        data-tip="Stiwi was here 👽"
        className="tooltip tooltip-left absolute top-0 right-0 m-4 p-3"
      ></div>
      {/* Encabezado fijo */}
              ...
              <li>
                <div className="join grid grid-cols-2 mt-3">
                  <Link
                    ...
                    legacyBehavior
                  >
                    <button className="join-item btn-info btn btn-outline">
                      Atrás
                    </button>
                  </Link>
                  <Link
                    href="/certificados_cursos/cert_export/page"
                    passHref
                    legacyBehavior
                  >
