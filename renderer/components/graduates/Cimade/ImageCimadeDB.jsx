...
class NewDataCimade extends Dexie {
  constructor() {
    super("NewDataCimade");
...
const newDB = new NewDataCimade(); // Cambia el nombre de la instancia de la base de datos
...
export { useUploader, NewDataCimade }; // Cambia el nombre de la función exportada y de la instancia de la base de datos
