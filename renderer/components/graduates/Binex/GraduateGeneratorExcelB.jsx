...
const generateCertificate = async (participant, imageDataURL) => {
  ...
  return (
    <>
      <button
        className="w-full btn text-xl font-Century Gothic  items-center  bg-gradient-to-b from-[#04d74b] to-[#056622] text-white  hover:bg-gray-200  mb-5 rounded-lg"
      ...
      <button
        className="w-full btn text-lg font-Century Gothic bg-gradient-to-b from-[#c70606] to-[#660505] text-white hover:bg-red-400 mb-5"
