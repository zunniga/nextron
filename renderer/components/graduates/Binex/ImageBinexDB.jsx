...
class NewDataBinex extends Dexie {
  constructor() {
    super("NewDataBinex");
...
const newDB = new NewDataBinex(); // Cambia el nombre de la instancia de la base de datos
...
export { useUploader, NewDataBinex }; // Cambia el nombre de la función exportada y de la instancia de la base de datos
