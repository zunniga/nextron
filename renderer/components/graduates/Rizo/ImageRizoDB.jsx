...
class NewDataRizo extends Dexie {
  constructor() {
    super("NewDataRizo");
...
const newDB = new NewDataRizo(); // Cambia el nombre de la instancia de la base de datos
...
export { useUploader, NewDataRizo }; // Cambia el nombre de la función exportada y de la instancia de la base de datos
