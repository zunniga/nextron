...
class NewDataPromas extends Dexie {
  constructor() {
    super("NewDataPromas");
...
const newDB = new NewDataPromas(); // Cambia el nombre de la instancia de la base de datos
...
export { useUploader, NewDataPromas }; // Cambia el nombre de la función exportada y de la instancia de la base de datos
